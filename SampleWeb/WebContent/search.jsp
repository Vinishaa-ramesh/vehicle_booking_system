...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<div>
		...
		<div class="search">
			<form action="search.jsp" metod="post">
	...
	<div class="row">
	<%try{
		String searchi=request.getParameter("search-info");
		Class.forName("com.mysql.cj.jdbc.Driver");
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","Omkr786#");
		Statement stmt=con.createStatement();
		ResultSet rs=stmt.executeQuery("select * from products where name like '%"+searchi+"%'");
		while(rs.next()){ %>
		<div class="card">
